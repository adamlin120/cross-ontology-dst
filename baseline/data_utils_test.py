...
from schema_guided_dst.baseline import config, data_utils

_VOCAB_FILE = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "test_data/bert_vocab.txt"
)
...
class Dstc8DataProcessorTest(absltest.TestCase):
    ...
    def setUp(self):
        self._processor = data_utils.Dstc8DataProcessor(
            ...
            dataset_config=config.DatasetConfig(
                file_ranges={"train": range(1), "dev": None, "test": None},
                max_num_cat_slot=6,
    ...
    def test_tokenizer(self):
        ...
        utt_1_tokens, utt_1_aligns, utt_1_inv_alignments = self._processor._tokenize(
            test_utt_1
        )
        ...
        utt_2_tokens, utt_2_aligns, utt_2_inv_alignments = self._processor._tokenize(
            test_utt_2
        )
        expected_utt_1_inv_alignments = [(0, 4), (5, 5), (7, 13), (7, 13), (14, 14)]
        ...
        utt_3_tokens, utt_3_aligns, utt_3_inv_alignments = self._processor._tokenize(
            test_utt_3
        )
        self.assertEqual(utt_3_tokens, ["extra", "#", "#", "#", "#", "a", "##b", "##c"])
        self.assertEqual(
            utt_3_aligns, {0: 0, 4: 0, 5: 1, 6: 2, 8: 3, 9: 4, 10: 5, 12: 7}
        )
        self.assertEqual(
            utt_3_inv_alignments,
            [(0, 4), (5, 5), (6, 6), (8, 8), (9, 9), (10, 12), (10, 12), (10, 12)],
        )
    ...
    def test_get_dialog_examples(self):
        ...
        expected_summaries = [
            ...
            },
            {
                ...
                "service_name": "Homes_1",
                "active_intent": "FindApartment",
                "slot_values_in_state": {"area": "san jose"},
            },
            {
                "utt_tok_mask_pairs": [
                    ("[CLS]", 0),
                ...
                "service_name": "Homes_1",
                "active_intent": "FindApartment",
                "slot_values_in_state": {"number_of_beds": "2"},
            },
            {
                "utt_tok_mask_pairs": [
                    ("[CLS]", 0),
                ...
                "service_name": "Homes_1",
                "active_intent": "FindApartment",
                "slot_values_in_state": {"number_of_beds": "3", "area": "livermore"},
            },
            {
                "utt_tok_mask_pairs": [
                    ("[CLS]", 0),
