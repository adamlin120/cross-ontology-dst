            ...
            for frame in turn["frames"]:
                ...
                for slot_idx, slot in enumerate(service_schema.categorical_slots):
                    ...
                    if slot_status == data_utils.STATUS_DONTCARE:
                        ...
                        slot_values[slot] = service_schema.get_categorical_slot_values(
                            slot
                        )[value_idx]
                ...
                for slot_idx, slot in enumerate(service_schema.non_categorical_slots):
                    ...
                    if slot_status == data_utils.STATUS_DONTCARE:
                        ...
                        ch_start_idx = predictions["noncat_alignment_start"][
                            tok_start_idx
                        ]
                        ...
                        if ch_start_idx < 0 and ch_end_idx < 0:
                            ...
                            slot_values[slot] = system_utterance[
                                -ch_start_idx - 1 : -ch_end_idx
                            ]
                        elif ch_start_idx > 0 and ch_end_idx > 0:
                            # Add span from the user utterance.
                            slot_values[slot] = user_utterance[
                                ch_start_idx - 1 : ch_end_idx
                            ]
...
def write_predictions_to_file(
    predictions, input_json_files, schema_json_file, output_dir
):
